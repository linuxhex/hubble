...
public class GlobalExceptionHandler {
     ...
     * 处理SLS异常
     */
    @ExceptionHandler(com.ykc.cloudeyes.common.exception.SlsException.class)
    public Result<?> handleSlsException(com.ykc.cloudeyes.common.exception.SlsException e) {
